...
const PRODUCT = "evidencia-aplicada";
...
function runReceiver(encoded) {
  ...
  const location = {
    ...
    pathname: "/kinecheck-evidencia-aplicada/",
    search: "?course=evidencia-aplicada",
  };
  const window = {
    location,
    history: {
...
test("una sesión privada fresca se consume desde el fragmento y se limpia de la URL", () => {
  ...
  assert.equal(cleanedUrl, "/kinecheck-evidencia-aplicada/?course=evidencia-aplicada");
